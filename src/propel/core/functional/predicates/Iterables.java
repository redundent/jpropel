...
public final class Iterables {
	 ...
	 */
	@Predicate
	public static boolean containsAll(final Iterable element,
			final Iterable _items) {
		return Linq.containsAll(element, _items);
	}

	/**
	 * Predicate returning true when the function argument contains any of the
	 * given items
	 * 
	 * @throws NullPointerException
	 *             When an argument is null
	 */
	@Predicate
	public static boolean containsAny(final Iterable element,
			final Iterable _items) {
	...
	/**
	 * Predicate returning true when the length is greater than a specified
	 * value
	 * 
	 * @throws NullPointerException
	 *             When an argument is null
	 */
	@Predicate
	public static boolean lengthGreaterThan(final Iterable element,
			final int _len) {
		return _len >= 0 && Linq.count(element) > _len;
	}

	/**
	 * Predicate returning true when the length is greater than or equal to a
	 * specified value
	 * 
	 * @throws NullPointerException
	 *             When an argument is null
	 */
	@Predicate
	public static boolean lengthGreaterThanOrEqual(final Iterable element,
			final int _len) {
		return _len >= 0 && Linq.count(element) >= _len;
	}
	...
	/**
	 * Predicate returning true when the length is less than or equal to a
	 * specified value
	 * 
	 * @throws NullPointerException
	 *             When an argument is null
	 */
	@Predicate
	public static boolean lengthLessThanOrEqual(final Iterable element,
			final int _len) {
		return _len >= 0 && Linq.count(element) <= _len;
	}

	/**
	 * Predicate returning true when the length is not equal to a specified
	 * value
	 * 
	 * @throws NullPointerException
	 *             When an argument is null
	...
	/**
	 * Predicate returning true when the function argument does not contain an
	 * item
	 * 
	 * @throws NullPointerException
	 *             When an argument is null
	...
	/**
	 * Predicate returning true when the function argument does not contain all
	 * items
	 * 
	 * @throws NullPointerException
	 *             When an argument is null
	 */
	@Predicate
	public static boolean notContainsAll(final Iterable element,
			final Iterable _items) {
		return !Linq.containsAll(element, _items);
	}

	/**
	 * Predicate returning true when the function argument does not contain any
	 * of the given items
	 * 
	 * @throws NullPointerException
	 *             When an argument is null
	 */
	@Predicate
	public static boolean notContainsAny(final Iterable element,
			final Iterable _items) {
		return !Linq.containsAny(element, _items);
	}
