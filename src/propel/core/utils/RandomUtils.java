...
/**
 * Provides utility functionality for obtaining random data. Please note that
 * the random number generators are not thread safe.
 */
public final class RandomUtils {
	...
	/**
	 * Returns a random Int32, created by the information entropy from bytes in
	 ...
	 * inclusive minimum and exclusive maximum, created by java.util.Random
	 * 
	...
	/**
	 * Returns a random Int64, created by the information entropy from bytes in
	 * a newly created UUID.
	 */
	...
	/**
	 * Returns random bytes, created by the information entropy from bytes in a
	 * newly created Guid.
	 * 
	 * @throws IllegalArgumentException
	 *             An argument is out of range
	...
	/**
	 * Returns random text characters (uses the Base64 set). Randomness sourced
	 * from the information entropy of a new UUID.
	 * 
	 * @throws IllegalArgumentException
	 *             An argument is out of range.
	 */
	...
	/**
	 * Returns random text characters (uses the 0..9, A..Z and a..z character
	 * sets). Randomness sourced from the information entropy of a new UUID.
	 * 
	 * @throws IllegalArgumentException
	 *             An argument is out of range.
	 */
	...
	/**
	 * Returns random text characters (uses the Base64 set), created by a
	...
	/**
	 * Returns random text characters (uses the 0..9, A..Z and a..z character
	 * sets) created by a cryptographically secure source.
	 * 
	 * @throws IllegalArgumentException
	 *             An argument is out of range
	 */
